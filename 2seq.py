...
splitter = input('Укажите символ-разделитель ')
str_num = input('Введите список чисел с указанным разделителем ')
lst_num = str_num.split(splitter)
lst_num = list(set(lst_num))
print(lst_num)
